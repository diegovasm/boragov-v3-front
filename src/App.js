      ...
      <div className="App">  
        ...
        <AuthContextComponent>
          ...
          <Routes>
            ...
            <Route path= "/detalhes/:id" element={<DetalhesBoard />}> </Route>
            <Route path= "/cadastrar" element={<CadastrarBoard />}> </Route>
            <Route path= "/board/:busca" element={<BuscaBoard />}> </Route>
            <Route path= "/tags" element={<Tags />}> </Route>
            <Route path= "/users" element={<Users />}> </Route>
            <Route path= "/orgaos" element={<Orgaos />}> </Route>
            <Route path= "/orgaos/cadastrar" element={<CadastrarOrgao />}> </Route>
